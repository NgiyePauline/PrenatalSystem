...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> PRENATAL HOSPITAL SYSTEM</h2></br>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-reply" id="list-reply-list" role="tab" data-toggle="list" aria-controls="home">Messages</a>
        ...
        <div class="container-fluid">
          <div class="card">
            ...
            var options = document.getElementById("doctor1").querySelectorAll("option");
                                      ...
                                      fo
            <div class="col-md-4"><label for="location">
                               Location Address
                              </label></div>
                              <div class="col-md-8">
...
<div class="tab-pane fade" id="list-reply" role="tabpanel" aria-labelledby="list-reply-list">
...
<h1 class="orange">Messages</h1>
                    ...
                    while ($row = mysqli_fetch_array($result)){
                      ?>
<p class="bg-primary p-2 text-white rounded bold"><?php echo $row['message'];?>

                      <?php } ;?>
<form method="POST" action="addmessage.php">
   <input type="" name="patient" value="<?php echo $username;?>" style="display: none;">
    <input type="" name="email" value="<?php echo $email;?>" style="display: none;">
   <input type="" name="doctor" value="judy" style="display: none;">
 <textarea class="form-control" rows="3" name="message" value="judy"></textarea><br>
