...
$mail->FromName     = 'Prenatal online care system';
$host = 'https://'.$_SERVER['HTTP_HOST'];
$mail->Subject = "Message From Doctor Prenatal online care system";
$mail->Body  ="
...
<h2 style='color:black;margin-top:16px;padding-bottom:10px;'>Payment Success</h2>
<p style='color:black;text-align:left;'>Hello $name Your Payment KSH $amount for Billboard ID $ad_id Was Successfull.</p>            
</div>
</td>
</tr>
</div>
